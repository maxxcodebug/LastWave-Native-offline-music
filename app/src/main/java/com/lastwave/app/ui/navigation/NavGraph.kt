...
fun LastWaveNavHost(
    ...
    NavHost(
        ...
        composable(Screen.Login.route) {
            ...
            val offlineServiceEnabled by authViewModel.offlineServiceEnabled.collectAsStateWithLifecycle()
            val offlineMusicTreeUri by authViewModel.offlineMusicTreeUri.collectAsStateWithLifecycle()
            LoginScreen(
                offlineServiceEnabled = offlineServiceEnabled,
                offlineMusicTreeUri = offlineMusicTreeUri,
                onOfflineServiceChanged = authViewModel::enableOfflineService,
                onOfflineMusicFolderSelected = authViewModel::setOfflineMusicFolder,
        ...
        composable(Screen.OfflineMusic.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                OfflineMusicScreen(
                    onBack = { navController.popBackStack() },
                )
        ...
        composable(Screen.Settings.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                SettingsScreen(
                    ...
                    onOpenOfflineMusic = { navController.navigate(Screen.OfflineMusic.route) },
